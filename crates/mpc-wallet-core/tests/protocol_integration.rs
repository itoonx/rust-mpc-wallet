...
/// 4. Sign with new parties {1,4} using reshared shares
#[cfg(not(feature = "gg20-simulation"))]
#[tokio::test]
async fn test_gg20_reshare_add_party() {
    ...
    // Step 4: Sign with new parties {1,4} using reshared shares (now with Paillier aux info)
...
async fn test_gg20_reshare_change_threshold() {
    ...
    // Step 4: Sign with all 3 parties (now 3-of-3 required, with Paillier aux info)
